...
import random
import logging
logging.basicConfig(filename='output_basto_attention_6.log',level=logging.DEBUG)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--summary_path', type=str, default='./summaries/basto_attention_6/',help='Output path for summaries.')
    parser.add_argument('--checkpoint_every', type=int, default=1000,help='How often to save checkpoints.')
    parser.add_argument('--checkpoint_path', type=str, default='./checkpoints/basto_attention_6/model.ckpt',help='Output path for checkpoints.')
